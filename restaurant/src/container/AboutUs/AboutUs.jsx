    ...
    <div className="app__aboutus-content flex__center">
      <div className="app__aboutus-content_about">
        ...
        <p className="p__opensans">
          ...
          vitae risus quis consequat. Sed convallis turpis nec tincidunt varius.
          Aliquam faucibus elementum ante a dignissim. Aenean pharetra ligula ut
          quam eleifend ornare.
        </p>
